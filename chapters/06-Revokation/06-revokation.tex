...
\input{chapters/06-Revokation/CRLallgemein/crl}
...
\input{chapters/06-Revokation/CRL_XCA_nginx/CRLnginx}
...
\input{chapters/06-Revokation/OCSPallgemein/ocsp}
\subsection{Aufsetzen eines OCSP-Responders}
\input{chapters/06-Revokation/OCSPallgemein/responder}
\subsection{Verhalten moderner Browser bei OCSP}
\subsubsection{Mozilla Firefox}
\input{chapters/06-Revokation/OCSP_im_Browser/OCSPFirefox.tex}
\subsubsection{Google Chrome}
\input{chapters/06-Revokation/OCSP_im_Browser/OCSPChrome.tex}
\subsubsection{Microsoft Edge}
\input{chapters/06-Revokation/OCSP_im_Browser/OCSPEdge.tex}
\subsubsection{Apple Safari}
